...
import com.zzha.utils.adapter.CustomBaseAdapter;
import com.zzha.utils.adapter.CustomBaseAdapter.OnGetViewListener;
	...
	public void setListeners() {
		...
		adapter.setGetViewListener(new OnGetViewListener<Person>() {
			...
			public void onGetView(List<Person> items, int position,
				...
				textView_totalMoney.setText(person.getTotalMoney() + "元");
